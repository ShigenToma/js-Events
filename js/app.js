...
document.getElementById("one").addEventListener("onclick",moreContent);
...
document.getElementById("noMore").addEventListener("onclick",lessContent);
...
// var elm = document.getElementById('biggie')
//  elm.onmouseout =zoom;
//  elm.onmouseover=zoom;
...
var menuItems = ['French Fries', 'McDouble', 'Coke'];
 document.getElementById("showMenu").addEventListener("onclick",valueMenu);
function valueMenu() {
...
document.getElementById("oreo").addEventListener("onmouseover",showPrice);

var oreoPrice = 5.55;
function showPrice() {
 
    document.getElementById("price").innerHTML =(oreoPrice);
}
//7. Mr. Buttons
...
document.getElementById("Benjamin").addEventListener("click", quote);
...
document.getElementById("random").addEventListener("click", ranQuotes);
function ranQuotes() {
...
*/
document.getElementById("showHide").addEventListener("click", cat);
function cat() {
 // console.log('test')
    // var x = document.getElementById("catmoney");
